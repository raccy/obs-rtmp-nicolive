...
extern "C" void nicolive_msg_error(
    bool available_gui, const char *gui_message, const char *cui_message)
{
	nicolive_log_error("%s", cui_message);
	if (available_gui) nicolive_mbox_error(gui_message);
}

extern "C" void nicolive_msg_warn(
    bool available_gui, const char *gui_message, const char *cui_message)
{
...
extern "C" void nicolive_msg_info(
    bool available_gui, const char *gui_message, const char *cui_message)
{
